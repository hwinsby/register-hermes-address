...
export function NostrProvider({ children }: { children: React.ReactNode }) {
  const [data, setData] = useState<{ user: NDKUser; ndk: NDK } | undefined>(undefined);
...
export function useNDKUser(): NDKUser | undefined {
  const res = useNDKContext();
  if (res.isLoading === false) {
    if (typeof res.user === "undefined") {
      console.error("Nostr provider is not connected");
    }
  }
